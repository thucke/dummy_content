...
var eventListenerHandler= function(itemname, action, lang) {
    var loremIpsum = new LoremIpsum(action, lang);
    var el = document.querySelectorAll('[data-formengine-input-name="' + itemname + '"]')[0];
...
var eventListenerRteHandler= function(itemname, action, lang) {
    var loremIpsum = new LoremIpsum(action, lang);
    const domEditableElement = document.querySelector(':root > body .ck-editor__editable_inline');
    const editorInstance = domEditableElement.ckeditorInstance;
    editorInstance.setData( loremIpsum.generate() );
    this.blur();
    return false;
}

//make both event handlers visible in global context enables using then in the DOM
globalThis.eventListenerHandler = eventListenerHandler;
globalThis.eventListenerRteHandler = eventListenerRteHandler;
